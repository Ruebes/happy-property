...
export default function DashboardLayout({ children, basePath }: Props) {
  ...
  const crmMoreItems = [
    ...
    { to: '/admin/crm/finance',       key: 'crm.nav.finance'      },
    { to: '/admin/crm/ads',           key: 'crm.nav.ads'          },
    { to: '/admin/crm/statistics',    key: 'crm.nav.statistics'   },
    { to: '/admin/crm/webanalytics',  key: 'crm.nav.webanalytics' },
    { to: '/admin/crm/seo',           key: 'crm.nav.seo'          },
    { to: '/admin/crm/reviews',       key: 'crm.nav.reviews'      },
    { to: '/admin/crm/affiliates',    key: 'crm.nav.affiliates'   },
    { to: '/admin/crm/funnel',        key: 'crm.nav.funnel'       },
    { to: '/admin/crm/funnel-editor', key: 'crm.nav.funnelEditor' },
    { to: '/admin/crm/workflows',     key: 'crm.nav.workflows'    },
  ...
  const staffNavItemsAll: { to: string; key: string; perm?: PermissionArea; anyPerm?: PermissionArea[] }[] = [
    ...
    { to: '/admin/crm/workflows',      key: 'crm.nav.workflows',   perm: 'funnel'   },
    ...
    { to: '/admin/crm/thumbnails',     key: 'crm.nav.thumbnails',  perm: 'thumbnails' },
    { to: '/admin/crm/youtube',        key: 'crm.nav.youtube',     perm: 'youtube' },
